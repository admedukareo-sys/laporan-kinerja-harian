      ...
      <div className="flex items-center gap-md">
        ...
        <div className="flex items-center gap-sm cursor-pointer hover:bg-surface-container-low p-xs rounded-lg transition-all">
          <div className="text-right hidden lg:block">
            ...
            <p className="text-[10px] text-outline">Senior Developer</p>
          </div>
          <img
            className="w-10 h-10 rounded-full border-2 border-primary-fixed"
            alt="Foto profil Budi Santoso"
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuC2cVr1pgaIUPd8la9AQdL1D8NacUyTPYUWvTPPsiUoRaRArjGz02LQ_Wo1JQifBJbJt89kjEloS3KhcRI3qU6uSw388j1zJsKuK_mFITj28ru4Hqv8yFyVBXB2nNv_7TclMz4ZKcC5RbtbkL5Yd9E0FBulP3MXLafOpMlCZL5_CAavMivlmC2TylG84zYjlfCEK5Xrzjx--Xy786EJzXFRESsqSwA7pXn0Pk2J4VWjW4qD8gr-wKuw"
          />
        </div>
      </div>
    </header>
